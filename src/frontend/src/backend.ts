...
export class Backend implements backendInterface {
    ...
    async addTool(arg0: string, arg1: string, arg2: string, arg3: number, arg4: boolean, arg5: Array<string>, arg6: string, arg7: string): Promise<void> {
    ...
    async filterByCategory(arg0: string): Promise<Array<Tool>> {
        if (this.processError) {
            try {
    ...
    async getToolByName(arg0: string): Promise<Tool> {
        if (this.processError) {
            try {
                const result = await this.actor.getToolByName(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
